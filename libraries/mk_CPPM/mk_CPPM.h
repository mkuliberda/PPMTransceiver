...
#define FLYSKY_PULSE_SYNC 400

#define FLYSKY_FRAME_LENGTH 20060
#define FLYSKY_PULSE_CENTER 1500 // center of pulse
#define FLYSKY_FRAME_NOTSYNC 20060 // not synchronized +/-8us
#define FLYSKY_PULSE_SYNC 400// neg sync pulse starting PPM pulse
#define FLYSKY_GAP_SYNC 400 // neg sync pulse starting GAP pulse
...
#define FATSHARK_TRINITY_FRAME_LENGTH 22000 //frame length
#define FATSHARK_TRINITY_PULSE_CENTER 1500 // center of pulse
#define FATSHARK_TRINITY_PULSE_C100PC 413 // 100% centered stick mouvement
#define FATSHARK_TRINITY_PULSE_C125PC 516 // 125% centered stick mouvement
#define FATSHARK_TRINITY_PULSE_C150PC 620 // 150% centered stick mouvement
#define FATSHARK_TRINITY_PULSE_C200PC 826 // 200% centered stick mouvement

#define FATSHARK_TRINITY_FRAME_NOTSYNC 22000 // not synchronized +/-8us
#define FATSHARK_TRINITY_PULSE_SYNC 400// neg sync pulse starting PPM pulse
#define FATSHARK_TRINITY_GAP_SYNC 400 // neg sync pulse starting GAP pulse
...
#define CPPM_FRAME_NOTSYNC_CEIL CPPM_US_ceil(FATSHARK_TRINITY_FRAME_NOTSYNC + 135) //(R615X_FRAME_NOTSYNC + 100) // 2% max oscillator error
...
#define CPPM_FRAME_LENGTH_FLOOR CPPM_US_floor(FATSHARK_TRINITY_FRAME_LENGTH - 980) //(R615X_FRAME_LENGTH) // frame length too short ?

#define CPPM_MSERVO 8 // 9 servos maximum in a 22ms frame
#define CPPM_MSERVO_OUT1 6 // 9 servos maximum in a 22ms frame
#define CPPM_MSERVO_OUT2 8 // 9 servos maximum in a 22ms frame
